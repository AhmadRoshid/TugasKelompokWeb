jQuery("#simulation")
  .on("click", ".s-8264f917-ead4-47f3-a33b-81934a947666 .click", function(event, data) {
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/a24d577e-1e84-4e85-8bbb-e23ed50af056",
                    "transition": {
                      "type": "fade",
                      "duration": 500
                    }
  ...
  .on("mouseleave dragleave", ".s-8264f917-ead4-47f3-a33b-81934a947666 .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "target": [ "#s-8264f917-ead4-47f3-a33b-81934a947666 #s-Rectangle_1 > .backgroundLayer > .colorLayer" ],
                    "attributes": {
  ...
  .on("mouseenter dragenter", ".s-8264f917-ead4-47f3-a33b-81934a947666 .mouseenter", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
